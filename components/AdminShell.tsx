    ...
    <WebsiteProvider>
      <div className="flex flex-col h-screen" style={{ background: '#ffffff' }}>
        ...
        <main className="flex-1 overflow-y-auto" style={{ background: '#ffffff' }}>
          {/* Desktop sticky top bar — sits at the very top of the scroll area */}
          <div className="hidden md:flex md:items-center md:justify-between md:h-16 md:border-b md:border-[#e2e8f0] md:sticky md:top-0 md:z-30 md:bg-white md:px-8">
            <Breadcrumb />
            <TopBar />
          </div>
