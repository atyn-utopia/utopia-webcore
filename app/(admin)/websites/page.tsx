...
export default function WebsitesPage() {
  ...
  return (
    <div>
      ...
      <p className="text-sm mb-6" style={{ color: '#4a7a8a' }}>
                ...
                >
                  ...
                  <td className="px-5 py-4 align-middle">
                    <div className="flex items-center gap-2.5">
                      <div className="w-7 h-7 rounded-md flex items-center justify-center flex-shrink-0" style={{ background: '#e8f4f8' }}>
                  ...
                  <td className="px-5 py-4 align-middle">
                    ...
                    <span className="text-xs ml-1" style={{ color: '#7dbdd0' }}>total</span>
                  </td>
