        ...
        <>
            ...
            {selectedRows.length > 0 && (
              <div className="px-5 py-2.5 flex items-center justify-between gap-3"
                ...
                <button type="button" onClick={bulkDeleteSelected}
                  className="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full text-white transition-colors"
          ...
          <div className="sticky bottom-4 rounded-xl border flex items-center justify-between gap-3 flex-wrap px-5 py-3 shadow-sm"
            ...
            <button type="button" onClick={doSave} disabled={saving || !hasChanges}
              className="inline-flex items-center gap-2 text-sm font-semibold px-5 py-2 rounded-full text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
      ...
      <td className="px-3 py-2">
        <div className="flex items-center justify-center gap-1">
          <button type="button" onClick={onRemove} disabled={!canRemove}
            ...
            className="w-7 h-7 inline-flex items-center justify-center rounded-full border transition-colors disabled:opacity-40 disabled:cursor-not-allowed hover:border-red-400 hover:text-red-600"
          ...
          {isLast && (
            <button type="button" onClick={onAdd} title="Add another row"
              className="w-7 h-7 inline-flex items-center justify-center rounded-full border transition-colors hover:border-[var(--primary)] hover:text-[var(--primary)]"
